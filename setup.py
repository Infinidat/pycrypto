...
kw = {'name':"pycrypto",
      'version':"2.7.0.1",  # See also: lib/Crypto/__init__.py
      ...
      'ext_modules': plat_ext + [
            ...
            Extension("Crypto.Hash.SHA256",
                      include_dirs=['src/'],
                      sources=["src/SHA256.c", "src/malloc.c"]),
            Extension("Crypto.Hash.SHA224",
                      include_dirs=['src/'],
                      sources=["src/SHA224.c", "src/malloc.c"]),
            Extension("Crypto.Hash.SHA384",
                      include_dirs=['src/'],
                      sources=["src/SHA384.c", "src/malloc.c"]),
            Extension("Crypto.Hash.SHA512",
                      include_dirs=['src/'],
                      sources=["src/SHA512.c", "src/malloc.c"]),
            ...
            Extension("Crypto.Cipher._AES",
                      include_dirs=['src/'],
                      sources=["src/AES.c", "src/malloc.c"]),
            Extension("Crypto.Cipher._AESNI",
                      include_dirs=['src/'],
                      sources=["src/AESNI.c", "src/malloc.c"]),
            Extension("Crypto.Cipher._ARC2",
                      include_dirs=['src/'],
                      sources=["src/ARC2.c", "src/malloc.c"]),
            Extension("Crypto.Cipher._Blowfish",
                      include_dirs=['src/'],
                      sources=["src/Blowfish.c", "src/malloc.c"]),
            Extension("Crypto.Cipher._CAST",
                      include_dirs=['src/'],
                      sources=["src/CAST.c", "src/malloc.c"]),
            Extension("Crypto.Cipher._DES",
                      include_dirs=['src/', 'src/libtom/'],
                      sources=["src/DES.c", "src/malloc.c"]),
            Extension("Crypto.Cipher._DES3",
                      include_dirs=['src/', 'src/libtom/'],
                      sources=["src/DES3.c", "src/malloc.c"]),

            # Stream ciphers
            Extension("Crypto.Cipher._ARC4",
                      include_dirs=['src/'],
                      sources=["src/ARC4.c", "src/malloc.c"]),
            Extension("Crypto.Cipher._XOR",
                      include_dirs=['src/'],
                      sources=["src/XOR.c", "src/malloc.c"]),
